  ...
  <div className='resume'>
    ...
    <ul>
      <li>
        ...
        International options, to enable users to make International Payments
        with current exchange rates.
      </li>
      <li>
        <strong>Operated</strong> across several teams to enable these features
        by working with the code owners to develop features and fix bugs.
      </li>
      <li>
    ...
    <h3 id='williams-sonoma-inc-front-end-engineer-april-2021---june-2022-san-francisco-remote'>
      Williams Sonoma Inc : Front End Engineer / April 2021 - June 2022 / San
      Francisco / Remote
    </h3>
    <p>
      Worked on the Micro Front End team, transitioning Production pages from 6
      brands, into a unified Vue project.
    </p>
    <ul>
      <li>
        <strong>Engineered</strong> styling &amp; architectural updates to Vue
        components to all 6 supported brands, including; the Product Information
        pages for the Purchasing Component &amp; Product Flags Component, Shop
        pages, &amp; Content pages.
      </li>
      <li>
      ...
      <li>
        <strong>Managed</strong> &amp; Migrated pull requests from team-specific
        repos, to Bedrock &amp; Release Management repos, including batch
        cherry-picked commits from my team to the upstream repos.
      </li>
      <li>
    ...
    <ul>
      <li>
        <strong>Engineered</strong> the Memory Book Project Dashboard in React
        with custom Hooks, where project owners view and edit pages submitted
        from their contributors, and view information about their book.
      </li>
      <li>
        <strong>Built</strong> the Questionnaire as a new memory book content
        type, providing project owners a place to ask their contributors
        questions to answer for their collaborative memory book content.
      </li>
      <li>
      ...
      <li>
        <strong>Mentored</strong> a junior ui/ux designer by providing design
        advice to help him utilize Figma features more robustly, and to think
        about user experience from our user’s perspective, following a
        contextual flow of page elements.
      </li>
    </ul>
    <p>
